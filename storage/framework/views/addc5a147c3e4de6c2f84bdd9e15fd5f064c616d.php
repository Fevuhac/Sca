...
<div class="main">
    <div class="kl_shoot_fish clearfix">
        <h2 class="kl_title kl_desktop"><img src="<?php echo e(URL::asset('assets/images/title_shoot-fish.png')); ?>" alt=""></h2>
        ...
        <div class="kl_gif_shoot">
            <div class="kl_banner kl_mobile">
                <div class="kl_item">
                    ...
                    <a href="#" title="">
                        <img src="<?php echo e(URL::asset('assets/images/GIF/zKLUCKY-MOBILE-BANCAMUAXUAN-popUpGAME.gif')); ?>" alt="">
                    </a>
                </div>
            </div>
            <section class="kl_fixed kl_bcRutGon">
                <div class="kl_item">
                    <span class="kl_btnclose">X</span>
                    <a href="javascript(0)" title="Show Form" data-toggle="modal" data-target="#showForm">
                        <img src="<?php echo e(URL::asset('assets/images/GIF/KLUCKY-BANCAMUAXUAN-popUp-RutGon.gif')); ?>" alt="">
                    </a>
                </div>
            </section>
            <!-- kl_fixed -->
            <div class="kl_thantai kl_mobile">
                <img src="<?php echo e(URL::asset('assets/images/GIF/ThanTaiNhayNhay.gif')); ?>" alt="">
            </div>
        </div>
    </div>
</div>

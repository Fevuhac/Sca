...
<head>
    ...
    <meta name="robots" content="index,follow" />
    <link rel="icon" href="<?php echo e(URL::asset('assets/favicon.ico')); ?>" type="image/x-icon">  
    <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/run_css.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::asset('assets/lib/jquery-ui/jquery-ui.min.css')); ?>">
...
<body <?php if($routeName != 'home'): ?> class="kl_child" <?php else: ?> id="kl_home" <?php endif; ?> <?php if($routeName == "thuong-game-khung"): ?> id="kl_bonus_game" <?php endif; ?>>  
    <?php if($routeName != "thuong-game-khung"): ?>
        <?php echo $__env->make('frontend.partials.header-v2', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>    
    <?php endif; ?>
    <div id="Zoom">    
        <?php if($routeName == "thuong-game-khung"): ?>
            <?php echo $__env->make('frontend.partials.header-v2', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>    
    ...
    <?php echo $__env->make('frontend.modal.modal-'.$routeName, array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php if($routeName == "home"): ?>
    <section class="kl_fixed">
        <div class="kl_item">
            <span class="kl_btnclose">X</span>
            <a href="<?php echo e(route('tranh-tai')); ?>">
                <img src="<?php echo e(URL::asset('assets/images/GIF/KM-casino.gif')); ?>" alt="">
            </a>
        </div>
        <div class="kl_item">
            <span class="kl_btnclose">X</span>
            <a href="<?php echo e(route('iphone')); ?>" title="Sự kiện iPhone XS Max">
    ...
    <section class="kl_Cherry-MaiVang">
        <img src="<?php echo e(URL::asset('assets/images/GIF/Cherry-MaiVang.png')); ?>" alt="Mai vàng">
    </section>
    <?php endif; ?>
    
    <?php if($routeName == "ban-ca"): ?>
    <section class="kl_Cherry-MaiVang2 kl_desktop">
        <img src="<?php echo e(URL::asset('assets/images/Cherry-MaiVang.png')); ?>" alt="Mai vàng">
    </section>
    <section class="kl_Cherry-MaiVang2 kl_mobile">
        <img src="<?php echo e(URL::asset('assets/images/maivang2.gif')); ?>" alt="Hoa mai">
    </section>
    <!-- kl_Cherry-MaiVang -->
    <section class="kl_Gril kl_desktop">
        <img src="<?php echo e(URL::asset('assets/images/Girl_highlight.png')); ?>" alt="Hot girl">
    </section>
    <?php endif; ?>
    <?php if($routeName == "thuong-game-khung"): ?>
    <section class="kl_Cherry-MaiVang2 kl_desktop">
        <img src="<?php echo e(URL::asset('assets/images/Cherry-MaiVang.png')); ?>" alt="">
    </section>
    <?php endif; ?>
    <!-- Facebook -->
    <!-- Modal -->
            ...
            <div class="modal-content kl_modal_content kl_modal_betterlucknexttime kl_modal_submit">
                <div class="kl_btn_close_modal">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <img src="<?php echo e(URL::asset('assets/images/kl_close_modal.png')); ?>" alt="close">
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="kl_modal_video">
                        <iframe id="success_video" width="550" height="350" src="https://www.youtube.com/embed/<?php echo e($settingArr['youtube_id']); ?>?rel=0" frameborder="0" allowfullscreen id="load_video" allow=""></iframe>
                    </div>
                    <p class="text-center kl_text_while">ĐỪNG BỎ QUA ĐẠI HỘI QUAY SỐ CÙNG 500 ANH EM NGÀY 28/12! <br>THAM GIA NGAY! </p>
                     <div class="line">
                        <img src="<?php echo e(URL::asset('assets/images/line.png')); ?>" alt="Line">
                    </div>
                    <p class="text-center">
                        <a href="<?php echo $settingArr['zalo_group']; ?>" target="_blank" class="kl_btn mt-5">
    ...
    <div class="modal fade show" id="infoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        <div class="modal-dialog modal-dialog-centered kl_modal" role="document">
            <div class="modal-content kl_modal_content kl_modal_information kl_modal_information_home">
                <div class="kl_btn_close_modal">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <img src="<?php echo e(URL::asset('assets/images/kl_close_modal.png')); ?>">
                    </button>
                </div>
                <div class="modal-body">
                    <p class="kl_modal_title text-center kl_modal_title_size">
                    ...
                    <div class="kl_formInformation">
                        <form method="POST" action="<?php echo e(route('send-contact')); ?>" id="contactForm">
                        ...
                        <div class="kl_register">
                            ...
                            <div class="btn-group">
                                <a href="<?php echo $settingArr['facebook_messenger']; ?>" class="kl_btn mr-3" target="_blank">
                                    <span>CLICK NGAY</span>
                                </a>
                                <a href="<?php echo $settingArr['zalo_group']; ?>" class="kl_btn" target="_blank">
                                    <span>LIÊN HỆ LILY</span>
                                </a>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered kl_modal" role="document">
            <div class="modal-content kl_modal_content kl_modal_betterlucknexttime">
                ...
                <div class="modal-body">
                    ...
                    <div class="kl_modal_video">
                        <iframe width="550" id="losing_video" height="350" src="https://www.youtube.com/embed/<?php echo e($settingArr['youtube_id_losing']); ?>?rel=0&loop=1" frameborder="0" allowfullscreen id="load_video" allow=""></iframe>
                    </div>
                    <p class="text-center kl_text_while">Hãy Giữ Số May Mắn Này Cho Đại Hội Quay Số Ngày 28/12</p>
                    <p class="text-center">
                        <a href="<?php echo $settingArr['facebook_messenger']; ?>" target="_blank" class="kl_btn">
        ...
        <div class="modal-dialog modal-dialog-centered kl_modal" role="document">
            <div class="modal-content kl_modal_content kl_modal_prizes">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-center">
                        <a href="<?php echo $settingArr['zalo_group']; ?>" target="_blank" class="kl_btn">
        ...
        <div class="modal-dialog modal-dialog-centered kl_modal" role="document">
            <div class="modal-content kl_modal_content kl_modal_getNumber">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-center">
                        <a href="<?php echo e(route('home')); ?>" title="Quay ngay" class="kl_btn">
                            <span>Quay ngay</span>
                        </a>
                    </p>
        ...
        <div class="modal-dialog modal-dialog-centered kl_modal" role="document">
            <div class="modal-content kl_modal_content kl_modal_getNumber">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-center">
                        <a href="<?php echo e(route('huong-dan')); ?>" title="Kiểm tra ngay" class="kl_btn">
                    ...
                    <p class="text-center">
                        <a href="<?php echo $settingArr['zalo_group']; ?>" title="Hỗ trợ nhanh" target="_blank" class="kl_btn">
    ...
    <!-- Js Bootstrap -->
    <script src="<?php echo e(URL::asset('assets/lib/bootstrap/js/popper.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('assets/lib/bootstrap/js/bootstrap.min.js')); ?>"></script>
    <!-- Js Slick -->
    <script src="<?php echo e(URL::asset('assets/lib/owlcarousel/owl.carousel.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('assets/lib/slick/slick.min.js')); ?>"></script>    
    <script src="<?php echo e(URL::asset('assets/lib/jquery-ui/jquery-ui.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('assets/lib/jquery-ui/jquery.ui.datepicker-vi-VN.js')); ?>"></script>    
    <!-- Js Common -->
    <script src="<?php echo e(URL::asset('assets/js/main.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('assets/js/jquery.number.min.js')); ?>"></script>  
    <!-- ===== JS ===== -->
    
    <input type="hidden" value="<?php echo e(route('get-content')); ?>" id="route_get_content">
    <input type="hidden" value="<?php echo e(route('check-no')); ?>" id="route_check_no">
